...
namespace GameEngine {
	...
	void LoadMedia(void) {
		...
		R.LoadTexture<ObjectID::SNAKE_HEAD>("gfx/Snake/Snake_head2.png");
		R.LoadTexture<ObjectID::SNAKE_BODY>("gfx/Snake/Snake_body2.png");
		R.LoadTexture<ObjectID::SNAKE_TAIL>("gfx/Snake/Snake_tail2.png");
		R.LoadTexture<ObjectID::FOOD_APPLE>("gfx/Snake/Food_apple.png");

		R.LoadTexture<ObjectID::CELL_EMPTY>("gfx/empty.png");
		R.LoadTexture<ObjectID::CELL_WALL>("gfx/wall2.png");
	}
